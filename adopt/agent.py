...
class SubmissionAgent:
    ...
    def __init__(self):
        ...
        if not all([self.client_id, self.client_secret]):
            raise ValueError("Missing required environment variables: GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET")
        ...
        self.email_tool = SendEmailTool(self.api_manager)
    ...
    def _send_email(self, state: AgentState) -> AgentState:
        ...
        try:
            ...
            recipient_email = state["validation_result"]["validated_data"]["recipient_email"]
...
Gmail Message ID: {message_id}"""
    ...
    def process_submission(self, name: str, email: str, address: str, recipient_email: str) -> Dict[str, Any]:
